...
function takeUntilDestroyed(destroyRef) {
  ...
  const destroyed$ = new import_rxjs3.Observable((subscriber) => {
  ...
  return (source) => {
    return source.pipe((0, import_operators3.takeUntil)(destroyed$));
  };
}
function toObservable(source, options) {
  ...
  const subject = new import_rxjs3.ReplaySubject(1);
...
function wrapIntoObservable(value) {
  if ((0, import_rxjs4.isObservable)(value)) {
    return value;
  }
  if (isPromise(value)) {
  ...
  return (0, import_rxjs4.of)(value);
}
function canUseDom() {
...
function fromEventOutsideAngular(target, name, options) {
  ...
  return new import_rxjs4.Observable((subscriber) => {
    return runOutsideAngular(() => (
      ...
      (0, import_rxjs4.fromEvent)(target, name, options).subscribe(subscriber)
    ));
  });
}
...
var NzResizeService = class _NzResizeService {
  ...
  destroyRef = inject(DestroyRef);
  resizeSource$ = new import_rxjs5.Subject();
  listeners = 0;
  ...
  connect() {
    ...
    return this.resizeSource$.pipe((0, import_operators5.auditTime)(16), (0, import_operators5.finalize)(() => this.unregisterListener()));
  }
  disconnet() {
...
var NzDragService = class _NzDragService {
  ...
  requestDraggingSequence(event) {
    ...
    this.currentDraggingSequence = new import_rxjs5.Subject();
    return this.currentDraggingSequence.pipe((0, import_operators5.map)((e) => ({
      x: e.pageX - this.currentStartingPoint.x,
      y: e.pageY - this.currentStartingPoint.y
    })), (0, import_operators5.filter)((e) => Math.abs(e.x) > this.draggingThreshold || Math.abs(e.y) > this.draggingThreshold), (0, import_operators5.finalize)(() => this.teardownDraggingSequence()));
  }
...
var NzBreakpointService = class _NzBreakpointService {
  ...
  subscribe(breakpointMap, fullMap) {
    if (fullMap) {
      ...
      return this.resizeService.connect().pipe((0, import_operators5.map)(get), (0, import_operators5.startWith)(get()), (0, import_operators5.distinctUntilChanged)((x, y) => x[0] === y[0]), (0, import_operators5.map)((x) => x[1]));
    } else {
      const get = () => this.matchMedia(breakpointMap);
      return this.resizeService.connect().pipe((0, import_operators5.map)(get), (0, import_operators5.startWith)(get()), (0, import_operators5.distinctUntilChanged)());
    }
  }
...
var NzDestroyService = class _NzDestroyService extends import_rxjs5.Subject {
  ngOnDestroy() {
    this.next();
    this.complete();
  }
...
//# sourceMappingURL=chunk-25UW62SO.js.map
