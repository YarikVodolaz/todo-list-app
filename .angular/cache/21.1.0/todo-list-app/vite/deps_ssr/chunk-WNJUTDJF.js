...
var IconService = class _IconService {
  ...
  _jsonpIconLoad$ = new import_rxjs2.Subject();
  ...
  getRenderedContent(icon, twoToneColor) {
    ...
    const $iconDefinition = definition ? (0, import_rxjs2.of)(definition) : this._loadIconDynamically(icon);
    return $iconDefinition.pipe((0, import_operators2.map)((i) => {
      if (!i) {
        throw IconNotFoundError(icon);
      }
  ...
  _loadIconDynamically(type) {
    if (!this._http && !this._enableJsonpLoading) {
      return (0, import_rxjs2.of)(HttpModuleNotImport());
    }
    ...
    if (!inProgress) {
      ...
      const source = !this._enableJsonpLoading ? this._http.get(safeUrl, {
        responseType: "text"
      }).pipe((0, import_operators2.map)((literal) => __spreadProps(__spreadValues({}, icon), {
        icon: literal
      }))) : this._loadIconDynamicallyWithJsonp(icon, safeUrl);
      inProgress = source.pipe((0, import_operators2.tap)((definition) => this.addIcon(definition)), (0, import_operators2.finalize)(() => this._inProgressFetches.delete(type)), (0, import_operators2.catchError)(() => (0, import_rxjs2.of)(null)), (0, import_operators2.share)());
  ...
  _loadIconDynamicallyWithJsonp(icon, url) {
    return new import_rxjs2.Observable((subscriber) => {
      ...
      this._jsonpIconLoad$.pipe((0, import_operators2.filter)((i) => i.name === icon.name && i.theme === icon.theme), (0, import_operators2.take)(1)).subscribe((i) => {
        subscriber.next(i);
        clean();
      });
    });
...
var NzIconService = class _NzIconService extends IconService {
  ...
  configUpdated$ = new import_rxjs3.Subject();
  get _disableDynamicLoading() {
...
var NzIconDirective = class _NzIconDirective extends IconDirective {
  ...
  changeIcon2() {
    ...
    const svgOrRemove$ = wrapIntoObservable(this._changeIcon()).pipe(
      ...
      (0, import_rxjs3.debounceTime)(0, this.isBrowser ? import_rxjs3.animationFrameScheduler : import_rxjs3.asapScheduler),
      takeUntilDestroyed(this.destroyRef),
      (0, import_rxjs3.finalize)(removeTask)
    );
...
var NzFormNoStatusService = class _NzFormNoStatusService {
  noFormStatus = new import_rxjs4.BehaviorSubject(false);
...
var NzFormStatusService = class _NzFormStatusService {
  formStatusChanges = new import_rxjs4.ReplaySubject(1);
...
//# sourceMappingURL=chunk-WNJUTDJF.js.map
