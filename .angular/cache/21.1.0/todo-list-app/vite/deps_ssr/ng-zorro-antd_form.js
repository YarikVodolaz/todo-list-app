...
var NzAnimationTreeCollapseService = class _NzAnimationTreeCollapseService {
  firstRender = true;
  virtualScroll = false;
  animationDone$ = new import_rxjs.Subject();
  constructor() {
    this.animationDone$.pipe((0, import_operators.debounceTime)(50), (0, import_operators.take)(1)).subscribe(() => {
      this.firstRender = false;
    });
  }
...
var NzI18nService = class _NzI18nService {
  _locale;
  _change = new import_rxjs2.BehaviorSubject(this._locale);
  dateLocale;
  get localeChange() {
...
function isDataSource(value) {
  return value && typeof value.connect === "function" && !(value instanceof import_rxjs3.ConnectableObservable);
}
...
var FixedSizeVirtualScrollStrategy = class {
  _scrolledIndexChange = new import_rxjs5.Subject();
...
var ScrollDispatcher = class _ScrollDispatcher {
  ...
  _scrolled = new import_rxjs5.Subject();
  _scrolledCount = 0;
...
var CdkScrollable = class _CdkScrollable {
  ...
  _cleanupScroll;
  _elementScrolled = new import_rxjs5.Subject();
  constructor() {
  }
  ngOnInit() {
...
var ViewportRuler = class _ViewportRuler {
  ...
  _listeners;
  _viewportSize = null;
  _change = new import_rxjs5.Subject();
...
var CdkVirtualScrollViewport = class _CdkVirtualScrollViewport extends CdkVirtualScrollable {
  ...
  _platform = inject(Platform);
  _detachedSubject = new import_rxjs5.Subject();
  _renderedRangeSubject = new import_rxjs5.Subject();
  _renderedContentOffsetSubject = new import_rxjs5.Subject();
  get orientation() {
  ...
  appendOnly = false;
  scrolledIndexChange = new import_rxjs5.Observable((observer) => this._scrollStrategy.scrolledIndexChange.subscribe((index) => Promise.resolve().then(() => this.ngZone.run(() => observer.next(index)))));
  _contentWrapper;
  renderedRangeStream = this._renderedRangeSubject;
  renderedContentOffset = this._renderedContentOffsetSubject.pipe((0, import_operators2.filter)((offset) => offset !== null), (0, import_operators2.distinctUntilChanged)());
  _totalContentSize = 0;
  ...
  _viewportChanges = import_rxjs5.Subscription.EMPTY;
  ...
  ngOnInit() {
    ...
    this.ngZone.runOutsideAngular(() => Promise.resolve().then(() => {
      ...
      this.scrollable.elementScrolled().pipe((0, import_operators2.startWith)(null), (0, import_operators2.auditTime)(0, SCROLL_SCHEDULER), (0, import_operators2.takeUntil)(this._destroyed)).subscribe(() => this._scrollStrategy.onContentScrolled());
...
var CdkVirtualForOf = class _CdkVirtualForOf {
  ...
  viewChange = new import_rxjs5.Subject();
  _dataSourceChanges = new import_rxjs5.Subject();
  get cdkVirtualForOf() {
  ...
  dataStream = this._dataSourceChanges.pipe((0, import_operators2.startWith)(null), (0, import_operators2.pairwise)(), (0, import_operators2.switchMap)(([prev, cur]) => this._changeDataSource(prev, cur)), (0, import_operators2.shareReplay)(1));
  _differ = null;
  _data = [];
  _renderedItems = [];
  _renderedRange = {
...
var OverlayRef = class {
  ...
  _injector;
  _renderer;
  _backdropClick = new import_rxjs6.Subject();
  _attachments = new import_rxjs6.Subject();
  _detachments = new import_rxjs6.Subject();
  _positionStrategy;
  _scrollStrategy;
  _locationChanges = import_rxjs6.Subscription.EMPTY;
  _backdropRef = null;
  _detachContentMutationObserver;
  _detachContentAfterRenderRef;
  _disposed = false;
  _previousHostParent;
  _keydownEvents = new import_rxjs6.Subject();
  _outsidePointerEvents = new import_rxjs6.Subject();
  _afterNextRenderRef;
...
var FlexibleConnectedPositionStrategy = class {
  ...
  _positionChanges = new import_rxjs6.Subject();
  _resizeSubscription = import_rxjs6.Subscription.EMPTY;
  _offsetX = 0;
  _offsetY = 0;
...
var CdkConnectedOverlay = class _CdkConnectedOverlay {
  ...
  _overlayRef;
  _templatePortal;
  _backdropSubscription = import_rxjs6.Subscription.EMPTY;
  _attachSubscription = import_rxjs6.Subscription.EMPTY;
  _detachSubscription = import_rxjs6.Subscription.EMPTY;
  _positionSubscription = import_rxjs6.Subscription.EMPTY;
  _offsetX;
  _offsetY;
  _position;
...
var NzTooltipBaseDirective = class _NzTooltipBaseDirective {
  ...
  component;
  destroy$ = new import_rxjs8.Subject();
  triggerDisposables = [];
  delayTimer;
  elementRef = inject(ElementRef);
  ...
  createComponent() {
    ...
    this.initProperties();
    const visibleChange$ = this.component.nzVisibleChange.pipe((0, import_operators5.distinctUntilChanged)());
    visibleChange$.pipe(takeUntilDestroyed(this.destroyRef)).subscribe((visible) => {
      this.internalVisible = visible;
      this.visibleChange.emit(visible);
    });
    visibleChange$.pipe((0, import_operators5.filter)(Boolean), (0, import_operators5.delay)(0, import_rxjs8.asapScheduler), (0, import_operators5.filter)(() => Boolean(this.component?.overlay?.overlayRef)), takeUntilDestroyed(this.destroyRef)).subscribe(() => {
      this.component?.updatePosition();
    });
  }
  registerTriggers() {
...
var NzTooltipBaseComponent = class _NzTooltipBaseComponent {
  ...
  /** @deprecated Default is false, and customization is no longer supported. This will be removed in v22.0.0. */
  cdkConnectedOverlayPush = false;
  nzVisibleChange = new import_rxjs8.Subject();
  set nzVisible(value) {
...
function NzFormControlComponent_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext();
    ɵɵadvance();
    ɵɵclassMap(ɵɵpureFunction1(4, _c12, "ant-form-item-explain-" + ctx_r1.status));
    ɵɵadvance();
...
var NzFormDirective = (() => {
  ...
  return class NzFormDirective2 {
    ...
    dir = inject(Directionality).valueSignal;
    inputChanges$ = new import_rxjs9.Subject();
    getInputObservable(changeType) {
      return this.inputChanges$.pipe((0, import_operators6.filter)((changes) => changeType in changes), (0, import_operators6.map)((value) => value[changeType]));
    }
    constructor() {
      this.destroyRef.onDestroy(() => {
...
var NzFormControlComponent = class _NzFormControlComponent {
  ...
  destroyRef = inject(DestroyRef);
  _hasFeedback = false;
  validateChanges = import_rxjs9.Subscription.EMPTY;
  validateString = null;
  localeId;
  autoErrorTip;
  get disableAutoTips() {
  ...
  watchControl() {
    ...
    if (this.validateControl && this.validateControl.statusChanges) {
      this.validateChanges = this.validateControl.statusChanges.pipe((0, import_operators6.startWith)(null), takeUntilDestroyed(this.destroyRef)).subscribe(() => {
  ...
  constructor() {
    this.subscribeAutoTips(this.i18n.localeChange.pipe((0, import_operators6.tap)((locale2) => this.localeId = locale2.locale)));
    this.subscribeAutoTips(this.nzFormDirective?.getInputObservable("nzAutoTips"));
    this.subscribeAutoTips(this.nzFormDirective?.getInputObservable("nzDisableAutoTips").pipe((0, import_operators6.filter)(() => this.nzDisableAutoTips === void 0)));
  }
  ngOnChanges(changes) {
    const {
      nzDisableAutoTips,
...
var NzFormLabelComponent = class _NzFormLabelComponent {
  ...
  constructor() {
    if (this.nzFormDirective) {
      this.nzFormDirective.getInputObservable("nzNoColon").pipe((0, import_operators6.filter)(() => this.noColon === "default"), takeUntilDestroyed()).subscribe(() => this.cdr.markForCheck());
      this.nzFormDirective.getInputObservable("nzTooltipIcon").pipe((0, import_operators6.filter)(() => this._tooltipIcon === "default"), takeUntilDestroyed()).subscribe(() => this.cdr.markForCheck());
      this.nzFormDirective.getInputObservable("nzLabelAlign").pipe((0, import_operators6.filter)(() => this.labelAlign === "default"), takeUntilDestroyed()).subscribe(() => this.cdr.markForCheck());
      this.nzFormDirective.getInputObservable("nzLabelWrap").pipe((0, import_operators6.filter)(() => this.labelWrap === "default"), takeUntilDestroyed()).subscribe(() => this.cdr.markForCheck());
    }
  }
