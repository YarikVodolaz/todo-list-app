...
import "./chunk-JWKKJPFP.js";
import {
  NzGridModule
} from "./chunk-ACTFK4EQ.js";
import {
  Directionality,
  _getEventTarget,
  coerceCssPixelValue,
...
var NzTooltipBaseDirective = class _NzTooltipBaseDirective {
  ...
  createComponent() {
    ...
    this.initProperties();
    const visibleChange$ = this.component.nzVisibleChange.pipe((0, import_operators2.distinctUntilChanged)());
    visibleChange$.pipe(takeUntilDestroyed(this.destroyRef)).subscribe((visible) => {
      this.internalVisible = visible;
      this.visibleChange.emit(visible);
    });
    visibleChange$.pipe((0, import_operators2.filter)(Boolean), (0, import_operators2.delay)(0, import_rxjs3.asapScheduler), (0, import_operators2.filter)(() => Boolean(this.component?.overlay?.overlayRef)), takeUntilDestroyed(this.destroyRef)).subscribe(() => {
      this.component?.updatePosition();
    });
  }
  registerTriggers() {
...
var NzTooltipBaseComponent = class _NzTooltipBaseComponent {
  ...
  /** @deprecated Default is false, and customization is no longer supported. This will be removed in v22.0.0. */
  cdkConnectedOverlayPush = false;
  nzVisibleChange = new import_rxjs3.Subject();
  set nzVisible(value) {
...
var NzFormDirective = (() => {
  ...
  return class NzFormDirective2 {
    ...
    dir = inject(Directionality).valueSignal;
    inputChanges$ = new import_rxjs4.Subject();
    getInputObservable(changeType) {
      return this.inputChanges$.pipe((0, import_operators3.filter)((changes) => changeType in changes), (0, import_operators3.map)((value) => value[changeType]));
    }
    constructor() {
      this.destroyRef.onDestroy(() => {
...
var NzFormControlComponent = class _NzFormControlComponent {
  ...
  destroyRef = inject(DestroyRef);
  _hasFeedback = false;
  validateChanges = import_rxjs4.Subscription.EMPTY;
  validateString = null;
  localeId;
  autoErrorTip;
  get disableAutoTips() {
  ...
  watchControl() {
    ...
    if (this.validateControl && this.validateControl.statusChanges) {
      this.validateChanges = this.validateControl.statusChanges.pipe((0, import_operators3.startWith)(null), takeUntilDestroyed(this.destroyRef)).subscribe(() => {
  ...
  constructor() {
    this.subscribeAutoTips(this.i18n.localeChange.pipe((0, import_operators3.tap)((locale2) => this.localeId = locale2.locale)));
    this.subscribeAutoTips(this.nzFormDirective?.getInputObservable("nzAutoTips"));
    this.subscribeAutoTips(this.nzFormDirective?.getInputObservable("nzDisableAutoTips").pipe((0, import_operators3.filter)(() => this.nzDisableAutoTips === void 0)));
  }
  ngOnChanges(changes) {
    const {
      nzDisableAutoTips,
...
var NzFormLabelComponent = class _NzFormLabelComponent {
  ...
  constructor() {
    if (this.nzFormDirective) {
      this.nzFormDirective.getInputObservable("nzNoColon").pipe((0, import_operators3.filter)(() => this.noColon === "default"), takeUntilDestroyed()).subscribe(() => this.cdr.markForCheck());
      this.nzFormDirective.getInputObservable("nzTooltipIcon").pipe((0, import_operators3.filter)(() => this._tooltipIcon === "default"), takeUntilDestroyed()).subscribe(() => this.cdr.markForCheck());
      this.nzFormDirective.getInputObservable("nzLabelAlign").pipe((0, import_operators3.filter)(() => this.labelAlign === "default"), takeUntilDestroyed()).subscribe(() => this.cdr.markForCheck());
      this.nzFormDirective.getInputObservable("nzLabelWrap").pipe((0, import_operators3.filter)(() => this.labelWrap === "default"), takeUntilDestroyed()).subscribe(() => this.cdr.markForCheck());
    }
  }
